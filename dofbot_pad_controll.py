...
def socket_on_connect(client2, userdata, flags, rc):
    print("socket 연결 성공, 결과 코드: " + str(rc))
    # camera 데이터를 topic 구독
    ...
    try:
        while True:
            ...
            if ret:
                ...
                publish_camera_data(buffer.tobytes())
...
def publish_camera_data(camera_data):
    client2.publish("jetson/camera", camera_data, qos=1)
...
client2.on_connect = socket_on_connect
...
if(flag == True):
    ...
    print("camera_thread not running")
